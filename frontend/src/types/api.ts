...
export type CashCarryOpportunity = {
  ...
  estimated_funding_income: string;
  estimated_open_close_fee: string;
  estimated_borrow_cost: string | null;
  estimated_net_profit: string;
  max_safe_notional_usdt: string | null;
  notional_usdt: string;
  margin_required_usdt: string;
  leverage: string;
  borrow_check_status: "not_required" | "ok" | "blocked" | "unknown";
  borrow_available_qty: string | null;
  borrow_daily_rate_pct: string | null;
  borrow_rate_period_hours: string | null;
  borrow_term: string | null;
  borrow_risk_tags: string[];
  blocked_reasons: string[];
  data_source: "mock" | "live";
  updated_at: string;
};
...
export type TradeHistory = {
  trade_pair_id: string;
  strategy_type: "perp_spread" | "cash_carry" | "reverse_cash_carry" | "mt4_spread";
  symbol: string;
  quantity: string;
  opened_at: string;
...
export type BotSettings = {
  ...
  reverse_cash_carry_min_discount_pct: string;
  reverse_cash_carry_close_discount_pct: string;
  reverse_cash_carry_min_funding_rate_pct: string;
  reverse_cash_carry_min_volume_usdt: string;
  reverse_cash_carry_borrow_hold_hours: string;
  reverse_cash_carry_repay_buffer_pct: string;
  ...
  reverse_cash_carry_enabled: boolean;
  reverse_cash_carry_auto_open_enabled: boolean;
  reverse_cash_carry_auto_close_enabled: boolean;
  reverse_cash_carry_auto_transfer_enabled: boolean;
  reverse_cash_carry_auto_borrow_enabled: boolean;
  reverse_cash_carry_auto_repay_enabled: boolean;
...
export type RealtimeSnapshot = {
  ...
  reverse_cash_carry_opportunities: CashCarryOpportunity[];
  reverse_cash_carry_candidates: CashCarryOpportunity[];
