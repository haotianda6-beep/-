...
CONFIG_FIELD_TO_ENV = {
    ...
    "gold_v2_min_entry_interval_ms": "GOLD_V2_MIN_ENTRY_INTERVAL_MS",
...
class Settings(BaseSettings):
    ...
    gold_v2_history_start_ms: int = Field(default=0, alias="GOLD_V2_HISTORY_START_MS")
    ...
    gold_v2_min_entry_interval_ms: int = Field(default=19_800_000, alias="GOLD_V2_MIN_ENTRY_INTERVAL_MS")
    ...
    @classmethod
    def non_negative_decimal(cls, value: Decimal) -> Decimal:
        if value < 0:
            raise ValueError("numeric buffer values must not be negative")
        return value
