...
def summarize_status(status: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "add_actionable_trigger": add_plan.get("next_actionable_trigger_edge"),
        "add_required_locked": add_plan.get("required_locked_edge"),
        "add_required_blended": add_plan.get("required_blended_edge"),
